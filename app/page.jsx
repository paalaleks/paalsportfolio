...
export default function Home() {
  ...
  return (
    <>
      <section className="z-20 relative min-h-screen flex justify-center items-center overflow-hidden">
        ...
        <div className="absolute max-w-5xl mx-auto pl-10 pr-8 sm:px-10">
          <Image
