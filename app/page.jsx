  ...
  return (
    <>
      <div className="relative">
        ...
        <section
          id="welcome"
          className="min-h-screen  flex flex-col justify-center items-center max-w-3xl mx-auto z-20 relative pl-14 pr-12"
        >
          <Image
          ...
          <p className="font-sans text-color2 mt-4 text-lg pl-4 text-center">
